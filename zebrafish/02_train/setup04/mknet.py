...
def create_network(input_shape, name):
    ...
    with tf.variable_scope('setup04'):
        ...
        summary = tf.summary.merge([
            tf.summary.scalar('setup04_eucl_loss', loss),
            tf.summary.scalar('setup04_eucl_loss_lsds', loss_lsds),
            tf.summary.scalar('setup04_eucl_loss_affs', loss_affs)
        ])
...
if __name__ == "__main__":
    ...
    create_network((148,148,148), 'train_net')
