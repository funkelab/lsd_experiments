...
import json
from funlib.learn.tensorflow.models.unet import unet, conv_pass
...
def create_network(input_shape, name):
    ...
    with tf.variable_scope('setup11'):
        ...
        summary = tf.summary.merge([
            tf.summary.scalar('setup11_eucl_loss', loss),
            tf.summary.scalar('setup11_eucl_loss_embedding', loss_embedding),
            tf.summary.scalar('setup11_eucl_loss_affs', loss_affs)
        ])
