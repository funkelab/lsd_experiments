...
def create_network(input_shape, name):
    ...
    with tf.variable_scope('setup01'):
        ...
        summary = tf.summary.merge([
            tf.summary.scalar('setup01_eucl_loss', loss),
            tf.summary.scalar('setup01_eucl_loss_embedding', loss_embedding),
            tf.summary.scalar('setup01_eucl_loss_affs', loss_affs)
        ])
