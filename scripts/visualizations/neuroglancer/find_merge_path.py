...
fragment_segment_lut_file = '/nrs/funke/sheridana/paper_runs/vanilla_euclidean/3_sample/no_glia/no_autocontext/setup66_p/400000/calyx.zarr/luts/fragment_segment/validation/seg_edges_hist_quant_50_60.npz'
...
def find_path(graph, frag_1, frag_2):
    ...
    print(path)
    npz = np.savez_compressed('%s_%s.npz'%(frag_1, frag_2), centers=centers, merge_scores=merge_scores)

    print('Saved mst as compressed numpy array')
...
if __name__ == '__main__':
    ...
    seg_id = 1541553
    frag_1 = 1033887550994
    frag_2 = 1033887553607
