...
def wrapper(args):
    args = (mask, box, downsample_factor, simplify_ratio, smoothing_rounds, output_format, out_dir, l)
    return generate_single_mesh(args)
...
def generate_meshes(
    ...
    print('Created pool with %i workers'%num_workers)
