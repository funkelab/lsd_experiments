...
db_name = 'zebrafinch_gt_skeletons_new_gt_10_10_20_testing'
...
if __name__ == "__main__":
    ...
    for i in rois:
        ...
        with open(os.path.join(path_to_configs, 'zebrafinch_%s_roi.json'%i), 'r') as f:
            config = json.load(f)
        ...
        graph_provider = daisy.persistence.MongoDbGraphProvider(
            ...
            node_attribute_collections={
                'zebrafinch_components_%s_roi_not_masked_not_relabelled'%i: ['component_id'],
            })
