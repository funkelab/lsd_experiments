...
def create_network(input_shape, name):
    ...
    with tf.variable_scope('setup07'):
        ...
        summary = tf.summary.merge([
            tf.summary.scalar('setup07_eucl_loss', loss),
            tf.summary.scalar('setup07_eucl_loss_lsds', loss_embedding),
            tf.summary.scalar('setup07_eucl_loss_affs', loss_affs)
            ])
...
if __name__ == "__main__":
    ...
    create_network((84+z, 268+xy, 268+xy), 'train_net')
