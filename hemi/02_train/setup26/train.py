...
def add_malis_loss(graph):
    ...
    malis_summary = tf.summary.scalar('setup26_malis_loss', malis_loss)
    lsd_summary = tf.summary.scalar('setup26_lsd_loss', lsd_loss)
    comb_summary = tf.summary.scalar('setup26_comb_loss', loss)

    summary = tf.summary.merge([
        malis_summary,
        lsd_summary,
        comb_summary],
        name='setup26_merged_loss')
...
def train_until(max_iteration):
    ...
    if phase == 'euclid':
        ...
        train_summary = 'setup26_merged_loss/setup26_merged_loss:0'
