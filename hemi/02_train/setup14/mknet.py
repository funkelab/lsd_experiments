...
def create_network(input_shape, name):
    ...
    with tf.variable_scope('setup14'):
        ...
        loss_weights_lsds = tf.placeholder(tf.float32, shape=output_shape)

        loss_weights_lsds_reshaped = tf.reshape(loss_weights_lsds, (1,) + output_shape)
