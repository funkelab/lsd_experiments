...
def create_affs_network(input_shape, intermediate_shape, expected_output_shape, name):
    ...
    summary = tf.summary.scalar('setup41_eucl_loss', loss)
...
if __name__ == "__main__":
    ...
    train_output_shape = (62, 56, 56)
    create_lsd_network(train_input_shape, train_intermediate_shape, 'train_lsd_net', 'setup06')
    ...
    test_output_shape = (62, 56+o, 56+o)
