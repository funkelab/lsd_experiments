...
def create_network(input_shape, name):
    ...
    with tf.variable_scope('setup129_p'):
        ...
        summary = tf.summary.merge([
            tf.summary.scalar('setup129_eucl_loss', loss),
            tf.summary.scalar('setup129_eucl_loss_lsds', loss_embedding),
            tf.summary.scalar('setup129_eucl_loss_affs', loss_affs)
            ])
