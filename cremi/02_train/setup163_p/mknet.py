...
def create_auto(input_shape, output_shape, name):
    ...
    with tf.variable_scope('setup131_p'):
...
def create_affs(input_shape, intermediate_shape, expected_output_shape, name):
    ...
    with tf.variable_scope('setup163_p'):
        ...
        summary = tf.summary.merge([
            tf.summary.scalar('setup163_eucl_loss', loss),
            tf.summary.scalar('setup163_eucl_loss_lsds', loss_embedding),
            tf.summary.scalar('setup163_eucl_loss_affs', loss_affs)
            ])
