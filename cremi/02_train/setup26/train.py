...
def add_malis_loss(graph):
    ...
    gt_affs_mask = tf.placeholder(tf.int64, shape=(12,62,56,56), name='gt_affs_mask')
    ...
    loss = malis.malis_loss_op(affs, 
        ...
        gt_affs_mask)
    malis_summary = tf.summary.scalar('setup26_malis_loss', loss)
...
def train_until(max_iteration):
    ...
    if phase == 'euclid':
        ...
        train_summary = 'setup26_malis_loss:0'
