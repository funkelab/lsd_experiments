...
def create_network(input_shape, name):
    ...
    with tf.variable_scope('setup69_p_noise_test_2'):
        ...
        summary = tf.summary.merge([
            tf.summary.scalar('setup69_noise_test_2_eucl_loss', loss),
            tf.summary.scalar('setup69_noise_test_2_eucl_loss_lsds', loss_embedding),
            tf.summary.scalar('setup69_noise_test_2_eucl_loss_affs', loss_affs)
            ])
