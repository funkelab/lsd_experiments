...
def create_auto(input_shape, output_shape, name):
    ...
    with tf.variable_scope('setup123_p'):
...
def create_affs(input_shape, intermediate_shape, expected_output_shape, name):
    ...
    with tf.variable_scope('setup155_p'):
        ...
        summary = tf.summary.merge([
            tf.summary.scalar('setup155_eucl_loss', loss),
            tf.summary.scalar('setup155_eucl_loss_lsds', loss_embedding),
            tf.summary.scalar('setup155_eucl_loss_affs', loss_affs)
            ])
