...
def add_malis_loss(graph):
    ...
    malis_summary = tf.summary.scalar('setup18_malis_loss', malis_loss)
    lsd_summary = tf.summary.scalar('setup18_malis_loss', lsd_loss)
    comb_summary = tf.summary.scalar('setup18_malis_loss', loss)

    summary = tf.summary.merge([
        malis_summary,
        lsd_summary,
        comb_summary],
        name='setup18_merged_loss')
...
def train_until(max_iteration):
    ...
    if phase == 'euclid':
        ...
        train_summary = 'setup18_merged_loss/setup18_merged_loss:0'
