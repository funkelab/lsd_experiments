...
def create_network(input_shape, name):
    ...
    with tf.variable_scope('setup09'):
        ...
        summary_affs =  tf.summary.scalar('setup09_eucl_loss_affs', loss_affs)
        summary_lsds =  tf.summary.scalar('setup09_eucl_loss_affs', loss_lsds)
        summary_comb =  tf.summary.scalar('setup09_eucl_loss_affs', loss)
        ...
        config = {
            ...
            'loss': loss.name,
            'loss_lsds': loss_lsds.name,
            'optimizer': optimizer.name,
            'input_shape': input_shape,
            'output_shape': output_shape,
            'summary': summary.name,
            'summary_lsds': summary_lsds.name
        }
...
if __name__ == "__main__":
    ...
    create_network((168, 168, 168), 'train_net')
